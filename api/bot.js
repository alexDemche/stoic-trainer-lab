...
<b>Обирай практику:</b>
• <b>Breath Flow</b> — метод квадратного дихання для повернення фокусу.
• <b>Sleep Shuffler</b> — швидке засинання.
• <b>Muscle Relaxation</b> — повне розслаблення тіла.
...
<b>Розробник:</b> Software Engineer & Stoic Student

Мета проекту — дати тобі інструменти для контролю розуму в будь-якій ситуації.`;
  
  return ctx.replyWithHTML(aboutText, getBackMenu());
});
